...
def get_rag_response(question: str, chunk_metadata: dict, k: int = 6) -> dict:
    ...
    try:
        ...
        f"{BACKEND_URL}/chat?context=True&k={k}",  # añadir k
        json=payload
        )
...
def generate_evaluation_dataset(n: int = 20, k : int = 6) -> dict:
    ...
    for i, chunk in enumerate(selected_chunks):
        ...
        try:
            ...
            res = get_rag_response(record.question, chunk['metadata'], k=k)
